...
char ssid[] = "TIKONA WIFI";  //SSID
char pass[] = "adityakaushik";  //Password
//-----------------------------------//
...
//-------------ThingSpeak Details-----------------//
unsigned long myChannelField =  1644749; //Channel ID
const int ChannelField1 = 1; //for Humidity
const int ChannelField2 = 2; //for Temperature
const char * myWriteAPIKey = "YVUVG2GIM8Y4H2EC"; //Your Write API Key
//-----------------------------------------------//
